...
export default function AddBatchTiming() {
  ...
  // const [formConstantValues, setFormConstantValues] = useState<FormValues[]>(BATCH_DETAILS_TIMING)
  ...
  return (
    <>
        ...
        {/* {formConstantValues.map((props: FormValues) => (
          <div key={props.id}>
            ...
            <span className='text-red-800'>
              {errors[props.id]?.type === 'required' && <div>This field is required</div>}
      ...
      <Table tableHeader={BatchTimeTableHeader()} tableBody={BatchTimeTableBody(batchTimings)} />
