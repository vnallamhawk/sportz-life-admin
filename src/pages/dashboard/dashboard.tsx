          ...
          <div className="lg:mt-0 mt-20 lg:mt-8 lg:p-6 px-2 py-4  lg:mt-5 relative shadow-sm rounded-2xl lg:col-start-1 lg:col-end-7 lg:row-start-2 lg:row-end-3 col-start-1 col-end-7  row-start-3 row-end-4 text-white bg-gray-950">
            <div className="flex items-center ">
              ...
              <div className="flex relative grow lg:ml-10 ml-0">
                <Image width={0} height={0} src={LittleBoy} className="absolute -bottom-[16px] lg:-bottom-[24px] left-0 lg:w-auto lg:max-w-none max-w-[85px]" alt="" />
              ...
              <div className="flex relative grow lg:ml-2">
                <Image width={0} height={0} src={ShortGirl} className="absolute -bottom-[16px] lg:-bottom-[24px] left-0 transform lg:scale-x-[1] scale-x-[-1] lg:w-auto lg:max-w-none max-w-[85px]" alt="" />
                <div className="lg:pl-36 pl-24 lg:text-left text-center">
        ...
        <div className="lg:grid-rows-12 lg:grid 2xl:w-3/12 grid-rows-[repeat(3,minmax(400px,550px))] gap-3 ml-6 lg:block hidden">
          ...
          <Card className="bg-white h-fit relative" title="UPCOMING TOURNAMENT">
            <div className="absolute top-7 right-4">
              <button className="">
                <Image width={0} height={0} src={ArrowLeft} className="w-auto h-auto filter  contrast-0 " alt="" />
              </button>
              <button className="ml-1 rotate-180">
                <Image width={0} height={0} src={ArrowLeft} className="w-auto h-auto text-black filter brightness-200 contrast-200" alt="" />
              </button>
            </div>
            <div className="flex items-center">
              <div className="bg-purple-900 w-[95px] h-[185px] relative rounded-lg">
                <Image width={0} height={0} src={Bollyball} alt="" className="w-auto h-auto absolute min-w-[95px] top-2/4 -right-7 -translate-y-1/2" />
              </div>
              <div className="ml-8 ">
