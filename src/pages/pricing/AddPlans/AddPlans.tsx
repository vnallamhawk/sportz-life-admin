...
export default function AddPlans() {
  ...
  const handleFeeTypeChange = (selectedOption: any) => {
    ...
    setFormData((prev: any) => ({
      ...
      // eslint-disable-next-line
      recurringType:
        selectedOption.value === "recurring" ? null : prev.recurringType,
    }));
  };
        ...
        <div className="grid-col-1 mt-8 grid gap-x-8 gap-y-4 lg:grid-cols-2 lg:gap-y-8">
          ...
          <div>
            <Select
              ...
              value={PLANNING_FEE_TYPE_OPTIONS.find(
                (option) => option.value === formData.feeType
              )}
            ...
            />
            {errors.feeType && (
              <div className="text-sm text-red-500">{errors.feeType}</div>
            )}
          </div>
          ...
          <div>
            ...
            {formData.isLate && (
              <div className="mt-4">
                ...
                />
                {errors.lateFee && (
                  <div className="text-sm text-red-500">{errors.lateFee}</div>
                )}
              </div>
            )}
          </div>
