    ...
    <>
      ...
      >
        <DialogHeader className='flex items-center justify-between px-6 pb-0'>
          <div className='font-heading text-2xl font-medium uppercase'>Add Ons</div>
          <button onClick={modalHandleOpen}>
            <Image width={0} height={0} src={Cross} alt='' className='h-auto w-auto' />
          </button>
        </DialogHeader>
        <DialogBody className='p-0'>
              ...
              <div className='flex'>
                ...
                <div className='ml-4'>
                  ...
                  <div className='text-lg text-[#6E7280]'>
                    We will white label your customized academy/club app in playstore/app store
                  </div>
                </div>
              </div>

              <div className='font-heading text-2xl font-medium uppercase'>$9.00/m</div>
            </div>
            <div className='mt-4 flex justify-between'>
              <div className='flex'>
                <div>
          ...
          <div className='mt-8 flex w-full items-center justify-between rounded-b-lg bg-burgundy-dark p-6 px-8 text-white'>
            <div className='font-heading text-3xl font-medium'>Total $18.00</div>
            <div className='rounded-lg bg-white px-12 py-2 text-lg text-[#974062]'>Add Ons</div>
          </div>
        </DialogBody>
      </Dialog>
      <Dialog
      ...
      >
        <DialogHeader className='flex items-center justify-between px-6 pb-0'>
          <div className='font-heading text-2xl font-medium uppercase'>Pricing Plan Structure</div>
