    ...
    <FormContext.Provider value={formProviderData}>
      <div className='grid grid-cols-6 grid-rows-1'>
        <Card className='col-span-4 ml-10 h-full p-0 pl-10 pt-10'>
          ...
          {currentStep === 2 && <AddStaffShift finalFormSubmission={finalFormSubmissionHandler} />}
        </Card>
        <Card className='col-span-2 hidden !rounded-l-none rounded-r-xl bg-stone-100 px-7 lg:block'>
          <div className='mb-10 font-heading text-2xl font-medium uppercase'>Staff Image</div>
